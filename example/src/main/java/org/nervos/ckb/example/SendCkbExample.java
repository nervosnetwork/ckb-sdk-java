...
import org.nervos.ckb.SmartTransactionBuilder;
...
public class SendCkbExample {
  public static void main(String[] args) throws IOException {
    ...
    Network network = Address.decode(sender).getNetwork();

    Iterator<TransactionInput> iterator = new InputIterator(sender);
    TransactionWithScriptGroups txWithGroups = new SmartTransactionBuilder(network, iterator)
