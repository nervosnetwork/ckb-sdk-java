...
public class Secp256k1Blake160MultisigAllSignerTest {
  ...
  public void testMultiScriptDecode() {
    ...
    Assertions.assertEquals(
        Secp256k1Blake160MultisigAllSigner.MultisigScript.decode(
            Numeric.hexStringToByteArray("0x000002029b41c025515b00c24e2e2042df7b221af5c1891fe732dcd15b7618eb1d7a11e6a68e4579b5be0114")),
        multisigScript);
    ...
    Assertions.assertThrows(
        ...
        () -> Secp256k1Blake160MultisigAllSigner.MultisigScript.decode(
            Numeric.hexStringToByteArray("0x000002039b41c025515b00c24e2e2042df7b221af5c1891fe732dcd15b7618eb1d7a11e6a68e4579b5be0114")));

    Assertions.assertThrows(
        IllegalArgumentException.class,
        () -> Secp256k1Blake160MultisigAllSigner.MultisigScript.decode(
            Numeric.hexStringToByteArray("0x000002029b41c025515b00c24e2e2042df7b221af5c1891f")));
  }
