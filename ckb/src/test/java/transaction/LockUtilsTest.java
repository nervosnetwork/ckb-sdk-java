...
public class LockUtilsTest {
  ...
  public void testGenerateLockScriptWithPrivateKey() {
    ...
    Assertions.assertArrayEquals(
        ...
        lock.codeHash);
    Assertions.assertArrayEquals(
        Numeric.hexStringToByteArray("0x36c329ed630d6ce750712a477543672adab57f4c"), lock.args);
  }
  ...
  public void testGenerateLockScriptWithAddress() {
    ...
    Assertions.assertArrayEquals(
        ...
        lock.codeHash);
    Assertions.assertArrayEquals(
        Numeric.hexStringToByteArray("0xa3b8598e1d53e6c5e89e8acb6b4c34d3adb13f2b"), lock.args);
  }
