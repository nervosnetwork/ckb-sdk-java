  ...
  void testFilterScript() throws IOException {
    ...
    key.filterScript(
        new Script(
            ...
            Numeric.hexStringToByteArray("0x13d640a864c7e84d60afd8ca9c6689d345a18f63e2e426c9623a2811776cf211"),
            Script.HashType.TYPE));

    CellsResponse cells =
        CkbIndexerFactory.getApi().getCells(key.build(), Order.ASC, 10, null);
