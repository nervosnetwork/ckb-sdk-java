...
* Add outputsValidator as parameter to sendCapacity rpc ([d6d715e](https://github.com/nervosnetwork/ckb-sdk-java/commit/d6d715e05d0877697f4f78f4f148b74df8d26487))

### BreakingChanges

Add outputsValidator as parameter to sendCapacity rpc which is used to validate the transaction outputs before entering the tx-pool, an optional string parameter (enum: default | passthrough ), null means using default validator, passthrough means skipping outputs validation 
