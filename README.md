...
6. [`register_addresses` example](./ckb-mercury-sdk/src/test/java/mercury/RegisterAddressesTest.java)
7. [`build_transfer_transaction` example](./ckb-mercury-sdk/src/test/java/mercury/TransferCompletionTest.java)
8. [`build_transfer_transaction` by action example](./ckb-mercury-sdk/src/test/java/mercury/ActionTest.java)
9. [`build_transfer_transaction` by source example](./ckb-mercury-sdk/src/test/java/mercury/SourceTest.java)
10. [`build_transfer_transaction` by normal address example1](./ckb-mercury-sdk/src/test/java/mercury/normal/AcpTest.java)
11. [`build_transfer_transaction` by normal address example2](./ckb-mercury-sdk/src/test/java/mercury/normal/ChequeTest.java)
12. [`build_transfer_transaction` by normal address example3](./ckb-mercury-sdk/src/test/java/mercury/normal/Secp256k1Test.java)
